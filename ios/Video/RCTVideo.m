...
//                  NSString *ss = [[[NSData alloc] initWithBase64EncodedData:spcData options:NSDataBase64DecodingIgnoreUnknownCharacters] base64EncodedStringWithOptions:0];
//                  NSString *userUpdate =[NSString stringWithFormat:@"spc=%@",ss, nil];
//                  NSData *data1 = [userUpdate dataUsingEncoding:NSUTF8StringEncoding];
                    
                    NSString *ss = [spcData base64EncodedStringWithOptions:0];
                    NSDictionary * dic = [NSDictionary dictionaryWithObjectsAndKeys:
                    ss,@"spc",
                    nil];
                    NSData *jsonBodyData = [NSJSONSerialization dataWithJSONObject:dic options:kNilOptions error:nil];
