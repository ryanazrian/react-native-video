...
public class ReactExoplayerViewManager extends ViewGroupManager<ReactExoplayerView> {
    ...
    private static final String PROP_CENCKEY = "cencKey";
    private static final String PROP_DRMENABLED = "drmEnabled";
    ...
    @ReactProp(name = PROP_CENCKEY)
    public void setCencKey(final ReactExoplayerView videoView, final String cencKey) {
        videoView.setCencKey(cencKey);
    }

    @ReactProp(name = PROP_DRMENABLED)
    public void setDrmEnabled(final ReactExoplayerView videoView, final boolean drmEnabled) {
        videoView.setDrmEnabled(drmEnabled);
    }
